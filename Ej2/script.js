...
const IMG_4 = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShhju8PdiVsXHC7QapvYp1Lhx4K4FBe5NntjAf58gapjlcCevX-yw1p8FPifnfuD3jt_k&usqp=CAU";
const IMG_5 = "https://www.guiarepsol.com/content/dam/repsol-guia/contenidos-imagenes/comer/cultura-gastronomica/el-desayuno-de-hotel-mas-alla-del-bufe/gr-cms-media-featured_images-none-c58d3bd2-57c8-4094-941e-f29f1599a756-1.jpg";
const IMG_6 = "https://media.tenor.com/r5a_QxNpB6UAAAAC/gracias-thanks.gif";
...
function grabarIngreso() {
    ...
    pInfoSelec.innerHTML = pInfoSelec.innerHTML + ", Ingresa " + reserva.ingreso;
  }
...
function pagServicios() {
    fieldset.innerHTML = `
        ...
        <button onclick="grabarServicios(); pagGracias();">Finalizar Reserva</button>
    `;
}

function grabarServicios() {
    reserva.servicios = document.querySelector("#serviciosOpc").value;
    pInfoSelec.innerHTML = pInfoSelec.innerHTML + ", " + reserva.servicios + " de servicio/s.";
  }
